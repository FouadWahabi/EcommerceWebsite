...
$(function() {
    ...
    $.get(url + 'product/loadComments/' + window.location.href.split('/')[window.location.href.split('/').length - 1] , function(o) {
    ...
    $('#add_comment').on('click', function() {
        if($('#comment_title').val().length > 0 && $('#comment_content').val().length > 0) {
            $.post(url + 'product/addComment/' + window.location.href.split('/')[window.location.href.split('/').length - 1], {comment_title: $('#comment_title').val(), comment_content: $('#comment_content').val(), comment_rating : $('#jRate').attr('value')} , function() {
